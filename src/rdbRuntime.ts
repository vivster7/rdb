...
export class RDBRuntime extends EventEmitter {
	 ...
	 */
	public async setBreakPoint(path: string, line: number): Promise<IRDBBreakpoint> {

		const bp: IRDBBreakpoint = { verified: false, line, id: this._breakpointId++ };
	 ...
	 */
	public clearBreakPoint(path: string, line: number): IRDBBreakpoint | undefined {
